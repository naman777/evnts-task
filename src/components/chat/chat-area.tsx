      ...
      <div className="p-4 pb-20">
        ...
        {showPrediction && (
          <div className="relative mt-4 rounded-md overflow-hidden">
            {/* Gradient Border */}
            <div className="absolute inset-0 -m-[2px] rounded-md bg-gradient-to-r from-[#1977F2] to-[#D22163] z-0"></div>

            {/* Card Content */}
            <div className="relative bg-transparent border border-[#6366f1]/10 shadow-md overflow-hidden z-10 rounded-md">
              {/* Close button */}
                      ...
                      {message.sender === "user" ? (
                        <div>
                          ...
                          <div className="p-2 flex justify-end pr-12 rounded-md">
                            <button
                              className="px-6 py-2 text-transparent bg-clip-text bg-gradient-to-r from-[#1977F2] to-[#D22163] border border-transparent rounded-md hover:bg-[#1977F2]/5 transition-colors text-xs font-medium cursor-pointer"
                              style={{
                                borderImage:
