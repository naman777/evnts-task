...
export default function ChatArea({
  ...
  return (
    <div className="relative h-[calc(100%-64px)] overflow-y-auto bg-[#f9f5f2]">
      <div className="absolute left-0 h-full w-6">
        ...
        {showPrediction && (
          <div className="relative mt-4 border border-gray-200 rounded-md bg-white">
            <div className="absolute right-2 top-2">
              <button onClick={onClosePrediction} className="p-1 rounded-full hover:bg-gray-100">
            ...
            <div className="text-center text-sm text-gray-500 py-2 border-t border-gray-200">End of Prediction</div>
